...
INSERT INTO `comments` VALUES (1, 1, 'p', 1, 'gatu', 'gatu.bit@gmail.com', 'http://gatu.me', 'Esto es un comentario de prueba :)', 1266277975, '127.0.0.1', 'Mozilla/5.0 (X11; U; Linux i686; en-US) AppleWebKit/532.5 (KHTML, like Gecko) Chrome/4.0.249.43 Safari/532.5', 'n');
